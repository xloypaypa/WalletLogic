 ...
 * it's the db config
 */
public class WalletDBConfig implements ConfigInterface, DBConfig {
    ...
    public static WalletDBConfig getConfig() {
        return (WalletDBConfig) ConfigManager.getConfigManager().getConfig(WalletDBConfig.class);
    }
