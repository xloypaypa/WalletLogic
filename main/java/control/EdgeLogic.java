    ...
    public void getEdge(String fromType, String toType) {
        SendEvent event = new SendEvent(socketChannel) {
            ...
            public boolean run() throws Exception {
                ...
                result.remove("_id");
                EdgeLogic.this.setSuccessMessage(this, "/getEdge", result);
                return true;
            }
        };
    ...
    public void getSuperEdgeList(String typename) {
        SendEvent event = new SendEvent(socketChannel) {
            ...
            public boolean run() throws Exception {
                ...
                EdgeLogic.this.setSuccessMessage(this, "/getSuperEdgeList", new BudgetEdgeCollection()
    ...
    public void getExtendEdgeList(String typename) {
        SendEvent event = new SendEvent(socketChannel) {
            ...
            public boolean run() throws Exception {
                ...
                EdgeLogic.this.setSuccessMessage(this, "/getExtendEdgeList", new BudgetEdgeCollection()
